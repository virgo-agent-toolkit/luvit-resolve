...
local test_simple = function(t, module, ext)
  t:not_nil(module, 'module is not found')
  t:equal(module.main, path.normalize(path.join(__dirname, './fixtures/simple' .. ext)), 'resolve_package resolves to wrong main')
...
test('test simple.lua - relpath, without extension', nil, function(t)
  ...
  test_simple(t, module, '.lua')
end)

test('test simple.lua - relpath, with .luvit extension', nil, function(t)
  local module = resolve.resolve_package('./fixtures/simple.luvit', __dirname)
  test_simple(t, module, '.luvit')
end)

test('test simple.lua - relpath, with .lua extension', nil, function(t)
...
test('test simple.lua - abspath, with .lua extension', nil, function(t)
  local module = resolve.resolve_package(path.join(__dirname, './fixtures/simple.lua'), __dirname)
  test_simple(t, module, '.lua')
end)

test('test simple.lua - abspath, with .luvit extension', nil, function(t)
  local module = resolve.resolve_package(path.join(__dirname, './fixtures/simple.luvit'), __dirname)
  test_simple(t, module, '.luvit')
end)

test('test module in directory - without package.lua and init has .luvit ext', nil, function(t)
  local module = resolve.resolve_package(path.join(__dirname, './fixtures/without_package_file_luvit'), __dirname)
  t:not_nil(module, 'module is not found')
  t:equal(module.main, path.normalize(path.join(__dirname, './fixtures/without_package_file_luvit/init.luvit')), 'resolve_package resolves to wrong main')
  t:is_nil(module.package, 'there is no package.lua for the package so module.package should be nil')
  t:equal(module.is_stdlib, false, 'the package is not a stdlib')
  t:equal(module.is_builtin, false, 'the package is not a builtin')
  t:finish()
...
test('test module in directory - without package.lua', nil, function(t)
  local module = resolve.resolve_package(path.join(__dirname, './fixtures/without_package_file'), __dirname)
  t:not_nil(module, 'module is not found')
  t:equal(module.main, path.normalize(path.join(__dirname, './fixtures/without_package_file/init.lua')), 'resolve_package resolves to wrong main')
  t:is_nil(module.package, 'there is no package.lua for the package so module.package should be nil')
  t:equal(module.is_stdlib, false, 'the package is not a stdlib')
  t:equal(module.is_builtin, false, 'the package is not a builtin')
  t:finish()
...
test('test module in directory - with package.lua', nil, function(t)
  local module = resolve.resolve_package(path.join(__dirname, './fixtures/with_package_file'), __dirname)
  t:not_nil(module, 'module is not found')
  t:equal(module.main, path.normalize(path.join(__dirname, './fixtures/with_package_file/O_O.lua')), 'resolve_package resolves to wrong main')
  t:not_nil(module.package, 'there is package.lua for the package so module.package should not be nil')
  t:equal(module.is_stdlib, false, 'the package is not a stdlib')
  t:equal(module.is_builtin, false, 'the package is not a builtin')
  t:finish()
end)
